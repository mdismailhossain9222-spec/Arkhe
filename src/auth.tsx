...
export const DEMO_EMAIL = 'client@arkhe.studio'
export const DEMO_PASSWORD = 'drawing-2026'
...
const USERS_KEY = 'arkhe.users.v1'
const SESSION_KEY = 'arkhe.session.v1'
const ATTEMPTS_KEY = 'arkhe.attempts.v1'
...
async function hashPassword(email: string, password: string) {
  const salted = `${password}::${email.toLowerCase()}::arkhe-demo-v1`
  try {
